      ...
      <div className=" h-[500px] border-2 border-red-100 w-[500px]">
        <div className=" mt-8 pl-3 pr-2 ">
          ...
          <input onChange={handleChangeusername} placeholder='Enter Your Email'  type="email" value={username}   className='mt-2 p-2 border-b-2  w-full outline-none focus:border-blue-700' />          
             ...
             <input type="password" placeholder='Enter Your Password' value={password} onChange={handlePasswordChange} className={!isValidPassword?'mt-2 p-2 border-b-2  w-full outline-none focus:border-red-700':'mt-2 p-2 border-b-2  w-full outline-none focus:border-blue-700' }/>
